...
(Ssequence
  (Sifthenelse (Ebinop Olt (Etempvar _id_dest tschar) (Evar _NUM_TASKS tint)
    ...
    (Sifthenelse (Ebinop Oeq
                   (Ederef
                     (Ebinop Oadd (Evar _send_hist (tarray tschar 16))
    ...
    (Sifthenelse (Ebinop Olt (Etempvar _id_dest tschar)
      ...
      (Ssequence
        (Sset _group_mem
          (Ederef
            (Ebinop Oadd (Evar _MCAST_MEMBER (tarray (tarray tschar 16) 8))
              (Ebinop Osub (Etempvar _id_dest tschar) (Evar _NUM_TASKS tint)
                tint) (tptr (tarray tschar 16))) (tarray tschar 16)))
        (Ssequence
          (Ssequence
            (Sset _i (Econst_int (Int.repr 0) tint))
            (Sloop
              (Ssequence
                ...
                (Sifthenelse (Ebinop Olt (Econst_int (Int.repr 0) tint)
                  ...
                  (Sifthenelse (Ebinop Olt (Econst_int (Int.repr 0) tint)
                                 (Ederef
                                   (Ebinop Oadd
                                     (Evar _send_hist (tarray tschar 16))
...
(Ssequence
  ...
  (Sifthenelse (Etempvar _t'1 tint)
    (Ssequence
      (Sset _dest_ip
        (Ederef
          (Ebinop Oadd (Evar _IP_ADDR (tarray (tarray tschar 16) 24))
    ...
    (Ssequence
      ...
      (Ssequence
        (Sset _group_mem
          (Ederef
            (Ebinop Oadd (Evar _MCAST_MEMBER (tarray (tarray tschar 16) 8))
              (Etempvar _i tint) (tptr (tarray tschar 16)))
            (tarray tschar 16)))
        (Sifthenelse (Ebinop Olt (Econst_int (Int.repr 0) tint)
                       (Ederef
