...
Module Info.
  ...
  Definition source_file := "src/config.c".
...
Definition v_PALS_PERIOD := {|
  gvar_info := tulong;
  gvar_init := (Init_int64 (Int64.repr 100000000) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
Definition v_MAX_CSKEW := {|
  gvar_info := tulong;
  gvar_init := (Init_int64 (Int64.repr 10000000) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
Definition v_MAX_NWDELAY := {|
  gvar_info := tulong;
  gvar_init := (Init_int64 (Int64.repr 15000000) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
Definition v_NUM_TASKS := {|
  gvar_info := tint;
  gvar_init := (Init_int32 (Int.repr 6) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
Definition v_PORT := {|
  gvar_info := tint;
  gvar_init := (Init_int32 (Int.repr 33333) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
Definition v_MCAST_MEMBER := {|
  ...
  gvar_init := (Init_int8 (Int.repr 0) :: Init_int8 (Int.repr 1) ::
                ...
                Init_int8 (Int.repr 0) :: Init_int8 (Int.repr 0) ::
                Init_space 10 :: Init_space 112 :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
